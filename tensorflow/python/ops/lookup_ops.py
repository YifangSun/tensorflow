...
@ops.RegisterGradient("LookupTableFindAndInsert")
@ops.RegisterGradient("LookupTableFindAndInsertV2")
def _LookupTableFindAndInsertGrad(op, grad):
  keys = op.inputs[1]
  return [ops.IndexedSlices(grad, keys), None, None, None]
