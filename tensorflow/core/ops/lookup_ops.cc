...
REGISTER_OP("LookupTableFindAndInsert")
    .Input("table_handle: Ref(string)")
    .Input("keys: Tin")
    .Input("default_value: Tout")
...
REGISTER_OP("LookupTableFastFind")
    .Input("table_handle: Ref(string)")
    .Input("keys: Tin")
    .Input("default_value: Tout")
    .Output("values: Tout")
...
REGISTER_OP("LookupTableFindAndInsertV2")
    .Input("table_handle: resource")
    .Input("keys: Tin")
    .Input("default_value: Tout")
    .Input("probability: float")
...
WHITELIST_STATEFUL_OP_FOR_DATASET_FUNCTIONS("LookupTableFindAndInsertV2");

REGISTER_OP("LookupTableFastFindV2")
    .Input("table_handle: resource")
    .Input("keys: Tin")
    .Input("default_value: Tout")
    .Output("values: Tout")
...
WHITELIST_STATEFUL_OP_FOR_DATASET_FUNCTIONS("LookupTableFastFindV2");
...
REGISTER_OP("LookupTableGetAttr")
    .Input("table_handle: resource")
    .Input("keys: Tkeys")
    .Input("attr_key: string")
    .Input("default_attr_value: float")
    .Output("attrs: float")
    .Attr("Tkeys: type")
    .SetShapeFn([](InferenceContext* c) {
      ShapeHandle handle;
      ...
      ShapeHandle attrs = c->UnknownShapeOfRank(2);
      c->set_output(0, attrs);
      return Status::OK();
    });

REGISTER_OP("LookupTableSetAttr")
    .Input("table_handle: resource")
    .Input("keys: Tkeys")
    .Input("attr_key: string")
    .Input("attr_values: float")
    .Attr("Tkeys: type")
    .SetShapeFn([](InferenceContext* c) {
      ShapeHandle handle;
      TF_RETURN_IF_ERROR(c->WithRank(c->input(0), 0, &handle));
...
REGISTER_OP("LookupTableBatchGradV2")
    .Input("indices: indice_dtype")
    .Input("grads: grad_dtype")
    .Input("batch: int32")
    .Input("ids: indice_dtype")
    .Input("counts: indice_dtype")
    .Output("values: grad_dtype")
    .Attr("indice_dtype: {int32,int64}")
    .Attr("grad_dtype: type")
    .SetShapeFn([](InferenceContext* c) {
      ShapeHandle handle;
      TF_RETURN_IF_ERROR(c->WithRank(c->input(0), 1, &handle));
      TF_RETURN_IF_ERROR(c->WithRank(c->input(1), 2, &handle));
      TF_RETURN_IF_ERROR(c->WithRank(c->input(2), 0, &handle));
      TF_RETURN_IF_ERROR(c->WithRank(c->input(3), 1, &handle));
      TF_RETURN_IF_ERROR(c->WithRank(c->input(4), 1, &handle));
...
REGISTER_OP("LookupTableExportValuesAndAttrs")
    .Input("table_handle: Ref(string)")
    .Output("keys: Tkeys")
    .Output("values: Tvalues")
    .Output("update_timestamp: uint64")
    .Output("attr_keys: string")
    .Output("attr_flags: int8")
    .Output("attr_values: float")
    .Attr("Tkeys: type")
    .Attr("Tvalues: type")
    .SetShapeFn([](InferenceContext* c) {
      ShapeHandle handle;
      ...
      TF_RETURN_IF_ERROR(c->WithRankAtLeast(values, 1, &values));
      ShapeHandle keys = c->Vector(c->Dim(values, 0));
      ShapeHandle update_ts = c->UnknownShapeOfRank(2);
      c->set_output(0, keys);
      c->set_output(1, values);
      c->set_output(2, update_ts);
...
REGISTER_OP("LookupTableExportValuesAndAttrsV2")
    .Input("table_handle: resource")
    .Output("keys: Tkeys")
    .Output("values: Tvalues")
    .Output("update_timestamp: uint64")
...
REGISTER_OP("LookupTableEraseByThreshold")
    .Input("table_handle: resource")
...
REGISTER_OP("LookupTableEraseByThresholdV2")
    .Input("table_handle: resource")
    .Input("threshold: uint64")
    .SetShapeFn([](InferenceContext* c) {
      ShapeHandle handle;
...
REGISTER_OP("LookupTableImportValuesAndAttrs")
    .Input("table_handle: Ref(string)")
    .Input("keys: Tin")
    .Input("values: Tout")
    .Input("update_timestamp: uint64")
    .Input("attr_keys: string")
    .Input("attr_flags: int8")
    .Input("attr_values: float")
    .Attr("Tin: type")
    .Attr("Tout: type")
    .SetShapeFn([](InferenceContext* c) {
...
REGISTER_OP("LookupTableImportValuesAndAttrsV2")
    .Input("table_handle: resource")
    .Input("keys: Tin")
    .Input("values: Tout")
    .Input("update_timestamp: uint64")
...
REGISTER_OP("LookupTableImportFromFile")
    .Input("table_handle: resource")
...
REGISTER_OP("MutableHashTableOfTensors")
    ...
    .Attr("distribution: string = 'truncated_normal'")
    .Attr("seed: int = 0")
    .Attr("seed2: int = 0")
    .Attr("mean: float")  // Seems cannot be double?
    .Attr("stddev: float")  // Same as
    .Attr("hash_table_segments: int >= 1")
    .Attr("tensor_cache_size: int >= 1")
    .Attr("update_ts_capacity: int >= 1")
    .SetIsStateful()
    .SetShapeFn(TwoElementOutput);
