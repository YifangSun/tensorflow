...
#include "third_party/seastar/include/seastar/core/channel.hh"
#include "third_party/seastar/include/seastar/core/distributed.hh"

namespace tensorflow {

class SeastarEngine {
 public:
  SeastarEngine(uint16_t local, SeastarWorkerService* worker_service, std::shared_ptr<SeastarPortMgr> seastar_port_mgr);
 ...
 private:
  ...
  size_t core_number_;
  std::shared_ptr<SeastarPortMgr> seastar_port_mgr;
};
